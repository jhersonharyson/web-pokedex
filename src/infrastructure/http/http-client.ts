...
export const httpClient = (config: any, contentType?: string): any => {

  const service = createClient(config);
  setHeaderInterceptor(service, contentType, config);
...
function setHeaderInterceptor(service: AxiosInstance, contentType: string | undefined, config: any) {
